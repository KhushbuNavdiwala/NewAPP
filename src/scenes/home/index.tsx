            ...
            <div className='z-10 mt-32 md-basic-3/5'>
                ...
                >
                    <div className='relative'>
                        <div className="before:absolute before:-top-20  before:z-[-1]   md:before:content-evolvetext"> {/* (before and after in class)here in class for ralative and absolute is for shadow of images*/}
                            {/*Image for heading */}
