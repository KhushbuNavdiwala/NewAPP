...
const Home = ({ setSelectedPage }: Props) => {
    ...
    >
        ...
        >
            {/*onViewportEnter is allow whatever page you are on it highlight on navbar */}
            {/*Main header */}
            <div className='z-10 mt-32 md:basic-3/5'>
                ...
                <motion.div
                    ...
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5 }}//viewpoint means how many time you want animationand here is one time only
...
{/* (before and after in class)here in class for ralative and absolute is for shadow of images*/}
 <div className="before:absolute before:-top-20  
    ...
    Unrivaled Gym. Unparalleled Training Fitness Classes. World Class
      Studios to get the Body Shapes That you Dream of.. Get Your Dream Body Now.
        ...
        {/* Sponsor Layout */}
        {/* if screen is in large size then only you can see sponsor layout*/}
            ...
            <div className="h-[150px] w-full bg-primary-100 py-10">
                <div className="mx-auto w-5/6">
                    <div className="flex w-3/5 items-center justify-between gap ">
                        ...
                        <img alt="Sponsor-Fortun" src={SponsorFortune} />
